...
class QwenImageResample(nn.Module):
    ...
    Args:
        ...
        mode (str): The resampling mode. Must be one of:
            ...
            - 'upsample2d': 2D upsampling with nearest interpolation and convolution.
            - 'upsample3d': 3D upsampling with nearest interpolation, convolution, and causal 3D convolution.
